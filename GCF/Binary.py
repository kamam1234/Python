# -*- coding: utf-8 -*-
"""
Created on Tue Aug 22 14:19:15 2023
...
def update():
    sf = open(r'stu_recl.dat','rb')
    tp = open(r'temp.dat','wb')
    ...
    os.remove(r'stu_recl.dat')
    os.rename(r'temp.dat',r'stu_recl.dat')
...
while True:
    ...
    ch  = int(float(input('Enter your choice: ')))
